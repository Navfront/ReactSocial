...
export const PostCard: FC<IPostCardProps> = ({
  ...
  return (
    <li className="posts__item post">
      <h3 className="post__title">Реализация намеченных плановых заданий</h3>
      ...
      <div className="post__meta post-meta">
        <span className="post-meta__published">
          <span className="post-meta__published-pref">опубликовано</span>4 часа
          назад
        </span>
